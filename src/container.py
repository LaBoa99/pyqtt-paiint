...
class Ui_Paint(QWidget):
    ...
    def connect_signals(self):
        # Tools
        self.btnBorrador.clicked.connect(lambda _: self.itemClick(Herramientas.BORRADOR))
        self.btnCuadradoRedondo.clicked.connect(lambda _: self.itemClick(Herramientas.CUADRADO_REDONDO))
        self.btnCuentaGotas.clicked.connect(lambda _: self.itemClick(Herramientas.CUENTA_GOTAS))
        self.btnLapiz.clicked.connect(lambda _: self.itemClick(Herramientas.LAPIZ))
        self.btnCuadrado.clicked.connect(lambda _: self.itemClick(Herramientas.CUADRADO))
        self.btnCirculo.clicked.connect(lambda _: self.itemClick(Herramientas.CIRCULO))
        self.btnCubeta.clicked.connect(lambda _: self.itemClick(Herramientas.CUBETA))
        self.btnLinea.clicked.connect(lambda _: self.itemClick(Herramientas.LINEA))
        self.btnPincel.clicked.connect(lambda _: self.itemClick(Herramientas.PINCEL))
        self.btnTriangulo.clicked.connect(lambda _: self.itemClick(Herramientas.TRIANGULO))
        
        # Colors
        self.btnAmarillo.clicked.connect(lambda _: self.colorClick(self.btnAmarillo))
        self.btnAzul.clicked.connect(lambda _: self.colorClick(self.btnAzul))
        self.btnGris.clicked.connect(lambda _: self.colorClick(self.btnGris))
        self.btnMarron.clicked.connect(lambda _: self.colorClick(self.btnMarron))
        self.btnNegro.clicked.connect(lambda _: self.colorClick(self.btnNegro))
        self.btnRojo.clicked.connect(lambda _: self.colorClick(self.btnRojo))
        self.btnVerde.clicked.connect(lambda _: self.colorClick(self.btnVerde))
        self.btnBlanco.clicked.connect(lambda _: self.colorClick(self.btnBlanco))
        self.btnCafe.clicked.connect(lambda _: self.colorClick(self.btnCafe))
        self.btnCyan.clicked.connect(lambda _: self.colorClick(self.btnCyan))
        self.btnHueso.clicked.connect(lambda _: self.colorClick(self.btnHueso))
        self.btnLima.clicked.connect(lambda _: self.colorClick(self.btnLima))
    ...
    def colorClick(self, btn : QPushButton):
        color: QColor = btn.palette().color(btn.backgroundRole())
        self.onColorClick.emit(color)
    ...
    def setupUi(self, Paint):
        ...
        icon = QtGui.QIcon()
        print(self.path)
        icon.addPixmap(QtGui.QPixmap(f"{self.path}/assets/borrador.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.On)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(f"{self.path}/assets/cuenta_gotas.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(f"{self.path}/assets/lapiz.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(f"{self.path}/assets/cuadrado.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(f"{self.path}/assets/cuadrado_redondo.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(f"{self.path}/assets//cubetas.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.On)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(f"{self.path}/assets/pincel.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(f"{self.path}/assets/linea.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(f"{self.path}/assets/circulo.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(f"{self.path}/assets/triangulo.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
